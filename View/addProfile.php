<form id="signForm" action="index.php?main=profileAdded" method="post">
    ...
    <label for="birthday">Birthday : </label><input type="date" name="birthDate" placeholder="DD/MM/YYYY">
